...
namespace Colyseus
{
    ...
    public class ColyseusClient
    {
            ...
            Dictionary<string, string> headers = null)
        {
            ...
            room.SetConnection(CreateConnection("metabus-v4/"+response.room.processId + "/" + room.Id, queryString, headers));
...
#pragma warning restore 4014
            ...
            Dictionary<string, object> options, Dictionary<string, string> headers)
        {
            ...
            string json = await ColyseusRequest.Request("POST", $"metabus-v4/matchmake/{method}/{roomName}", options, headers);
