...
public class UIVirtualTouchZone : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    {
# if UNITY_EDITOR
        Debug.Log("@@@@@@@@@@@   " + PlayerData.myPlayerinfo.universityCode);
        var multiplier = PlayerData.myPlayerinfo.universityCode.Equals("AvatarView") ? 300f : 5;
        magnitudeMultiplier = multiplier;
# elif UNITY_ANDROID
        magnitudeMultiplier = 4;
#elif UNITY_IOS
        magnitudeMultiplier = 40;
#endif
